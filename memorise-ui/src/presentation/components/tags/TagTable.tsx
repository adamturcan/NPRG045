...
import { buildTagHierarchy, countAllTags } from "../../../shared/utils/thesaurusHelpers";
          ...
          {hasChildren && (
            <Box sx={{ px: 0.75, pb: 0.75, pt: hasTags ? 0 : 0.75 }}>
              {Array.from(node.children.values())
                .sort((a: HierarchyNode, b: HierarchyNode) => a.label.localeCompare(b.label, undefined, { sensitivity: 'base' }))
                .map((childNode: HierarchyNode) => (
                  <HierarchyGroup 
